...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $type = $_POST['type'];
        ...
        $sql = "INSERT INTO `national` (`Founders`, `Company Name`, `Address`, `Email`, `Phone`, `Information`, `Type` ) VALUES ('$founders', '$companyName', '$address', '$email', '$phone', '$information', '$type')";
...
<h1>These are National startups</h1> </div>`;
...
<div class="row">
    ...
    <form class="registerationForm" style="margin: 4em; font-size: 20px;" action="nationalStartup.php" method="post" id="registeration">
