...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $type = $_POST['type'];
        ...
        $sql = "INSERT INTO `international` (`Founders`, `Company Name`, `Address`, `Email`, `Phone`, `Information`, `Type` ) VALUES ('$founders', '$companyName', '$address', '$email', '$phone', '$information', '$type' )";
...
$sql2 = "SELECT * FROM `international`";
...
<body style="background-color: rgb(169,169 ,169 );">
    ...
    <form class="registerationForm" style="margin: 4em; font-size: 20px;" action="internationalStartup.php" method="post">
